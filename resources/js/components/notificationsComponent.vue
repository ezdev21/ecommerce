<template>
  <div>
  <button @click="notificationPopup=true" class="mx-3 flex hover:bg-green-500">
   ...
   <span v-if="notifications.length" class="text-3xl text-white">({{notifications.length}})</span>
  </button>

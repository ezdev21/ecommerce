<template>
 <div class="flex justify-evenly bg-green-500 w-full py-1">
  <div class="">
  ...
  <div class="py-1 pr-5 mx-2 mx-5">
    <div class="flex justify-between py-2 border-b-2 border-green-700">
    ...
    <div class="my-auto ml-5"> 
     <div v-if="userId" class="my-auto inline">
       <button @click="userDropdownMenu=true" class="my-auto flex">
        <span class="text-lg font-medium capitalize">{{user.name}}</span>
   ...
   <div class="py-2 my-auto flex justify-between">
    <div>
      <button class="text-xl font-semibold">Shop by category</button>
    </div>
    <div class="text-xl">
      <ul class="flex">

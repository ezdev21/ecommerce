<template>
  <div>
   <button @click="checkoutModal=true" class="text-xl bg-blue-500 text-white px-3 py-1 rounded m-1">buy</button>
   <div v-if="checkoutModal" class="absolute z-20 top-200 left-200 p-10 rounded-xl bg-white ">
